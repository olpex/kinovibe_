...
const BASE_MESSAGES: Record<string, string> = {
  ...
  "menu.discussHubHint": "Browse discussions the same way as TMDB: Movies, Actors, and TV Shows.",
  ...
  "discussion.formLabel": "Start a discussion",
  "discussion.placeholder": "Share your thoughts about {title}...",
...
const UK_MESSAGES: Record<string, string> = {
  ...
  "discussion.formLabel": "Почати обговорення",
  "discussion.placeholder": "Поділіться думкою про «{title}»...",
  ...
  "menu.discussHubHint": "Огляд обговорень у форматі TMDB: Фільми, Актори та Серіали.",
